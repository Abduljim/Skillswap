// Default skill catalogue — the single source of truth. The seed script and
// the server boot (ensureDefaultSkills) both upsert from this list, so new
// skills reach every database on the next deploy (additive, idempotent).
// ---------- Skill catalogue (200+ skills) ----------
export const SKILLS: Array<{ name: string; category: string; description?: string }> = [
  // ============== Technology ==============
