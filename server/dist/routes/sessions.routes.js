...
router.put('/:id', auth_1.requireAuth, (0, validate_1.validate)(schemas_1.updateSessionSchema), (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    const updated = await sessionService.updateSession(req.user.userId, req.params.id, req.body);
    (0, responses_1.ok)(res, updated);
}));
router.delete('/:id', auth_1.requireAuth, (0, asyncHandler_1.asyncHandler)(async (req, res) => {
