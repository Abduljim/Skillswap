...
var avatarUrlSchema = import_zod2.z.preprocess(
  (v) => v === "" ? null : v,
  import_zod2.z.string().max(2e6).refine(
...
var updateProfileSchema = import_zod2.z.object({
  ...
  occupation: import_zod2.z.preprocess((v) => v === "" ? null : v, import_zod2.z.enum(["student", "employed", "self_employed", "unemployed", "other"]).nullable()).optional(),
  jobTitle: import_zod2.z.string().max(100).nullable().optional(),
  company: import_zod2.z.string().max(150).nullable().optional(),
  gender: import_zod2.z.preprocess((v) => v === "" ? null : v, import_zod2.z.enum(["male", "female", "unspecified"]).nullable()).optional(),
  age: import_zod2.z.preprocess((v) => v === "" || v === null ? null : typeof v === "number" ? v : void 0, import_zod2.z.number().int().min(13).max(120).nullable()).optional(),
...
// src/sockets/io.ts
var io = null;
var connectedUsers = /* @__PURE__ */ new Set();
...
router10.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    await prisma.pushToken.upsert({
      ...
      update: { userId: req.user.userId, platform, updatedAt: /* @__PURE__ */ new Date() }
    });
...
var SKILLS = [
  ...
  // ============== Languages (more) ==============
  { name: "Turkish", category: "Languages", description: "Turkish language" },
  { name: "Dutch", category: "Languages", description: "Dutch language" },
  { name: "Polish", category: "Languages", description: "Polish language" },
  { name: "Greek", category: "Languages", description: "Greek (Modern) language" },
  { name: "Hebrew", category: "Languages", description: "Hebrew language" },
  { name: "Urdu", category: "Languages", description: "Urdu language" },
  { name: "Bengali", category: "Languages", description: "Bengali language" },
  { name: "Punjabi", category: "Languages", description: "Punjabi language" },
  { name: "Persian (Farsi)", category: "Languages", description: "Persian (Farsi) language" },
  { name: "Vietnamese", category: "Languages", description: "Vietnamese language" },
  { name: "Thai", category: "Languages", description: "Thai language" },
  { name: "Indonesian", category: "Languages", description: "Indonesian language" },
  { name: "Filipino (Tagalog)", category: "Languages", description: "Filipino (Tagalog) language" },
  { name: "Zulu", category: "Languages", description: "Zulu language" },
  { name: "Somali", category: "Languages", description: "Somali language" },
  { name: "Fula (Fulani)", category: "Languages", description: "Fula (Fulani) language" },
  { name: "Amharic", category: "Languages", description: "Amharic language" },
  { name: "Twi (Akan)", category: "Languages", description: "Twi (Akan) language" },
  // ============== University Subjects ==============
  { name: "Computer Science", category: "University", description: "Programs, data structures, and theory" },
  { name: "Software Engineering", category: "University", description: "Designing and building software systems" },
  { name: "Information Technology", category: "University", description: "Networks, systems, and IT support" },
  { name: "Business Administration", category: "University", description: "Management, strategy, and operations" },
  { name: "Law", category: "University", description: "Legal reasoning and core doctrines" },
  { name: "Medicine", category: "University", description: "Pre-med fundamentals and clinical basics" },
  { name: "Nursing", category: "University", description: "Patient care and clinical practice" },
  { name: "Pharmacy", category: "University", description: "Pharmacology and dispensing" },
  { name: "Physiotherapy", category: "University", description: "Rehabilitation and movement science" },
  { name: "Medical Laboratory Science", category: "University", description: "Diagnostics and lab procedures" },
  { name: "Civil Engineering", category: "University", description: "Structures, roads, and construction" },
  { name: "Mechanical Engineering", category: "University", description: "Machines, thermodynamics, and design" },
  { name: "Electrical Engineering", category: "University", description: "Circuits, power, and electronics" },
  { name: "Chemical Engineering", category: "University", description: "Processes and plant operations" },
  { name: "Petroleum Engineering", category: "University", description: "Drilling, production, and reservoirs" },
  { name: "Architecture", category: "University", description: "Design and construction of buildings" },
  { name: "Urban Planning", category: "University", description: "Designing cities and land use" },
  { name: "Mass Communication", category: "University", description: "Media, journalism, and broadcasting" },
  { name: "Criminology", category: "University", description: "Crime, justice, and correctional systems" },
  { name: "Political Science", category: "University", description: "Governance, policy, and politics" },
  { name: "Public Health", category: "University", description: "Community health and epidemiology" },
  { name: "Environmental Science", category: "University", description: "Ecology, climate, and conservation" },
  { name: "History", category: "University", description: "World and national history" },
  { name: "Geography", category: "University", description: "Physical and human geography" },
  { name: "Sociology", category: "University", description: "Society, culture, and institutions" },
  { name: "Philosophy", category: "University", description: "Logic, ethics, and critical thinking" },
  { name: "Education Studies", category: "University", description: "Theory and practice of teaching" },
  { name: "Early Childhood Education", category: "University", description: "Teaching young children" },
  { name: "Biochemistry", category: "University", description: "Chemistry of living systems" },
  { name: "Microbiology", category: "University", description: "Microbes, immunity, and disease" },
  { name: "Anatomy & Physiology", category: "University", description: "Human body structure and function" },
  { name: "Foreign Languages (Major)", category: "University", description: "Degree-level language study" },
  // ============== Careers & Jobs ==============
  { name: "CV Writing", category: "Careers", description: "Resumes that get interviews" },
  { name: "Cover Letter Writing", category: "Careers", description: "Letters that open doors" },
  { name: "LinkedIn Optimization", category: "Careers", description: "A profile recruiters notice" },
  { name: "Job Hunting", category: "Careers", description: "Searching and applying effectively" },
  { name: "Career Coaching", category: "Careers", description: "Choosing and growing a career path" },
  { name: "Workplace Communication", category: "Careers", description: "Emails, meetings, and collaboration" },
  { name: "Office Administration", category: "Careers", description: "Scheduling, records, and office tools" },
  { name: "Microsoft Office", category: "Careers", description: "Word, Excel, and PowerPoint" },
  { name: "Excel", category: "Careers", description: "Formulas, pivot tables, and dashboards" },
  { name: "PowerPoint", category: "Careers", description: "Presentations that persuade" },
  { name: "Data Entry", category: "Careers", description: "Fast, accurate record keeping" },
  { name: "Customer Service", category: "Careers", description: "Support skills for any industry" },
  { name: "Freelancing", category: "Careers", description: "Finding clients and pricing work" },
  { name: "Interview Skills", category: "Careers", description: "Acing phone and in-person interviews" },
  { name: "Teaching as a Career", category: "Careers", description: "Paths into the classroom" }
];
...
async function ensureDefaultSkills() {
  try {
    ...
    console.log(`\u{1F331} Catalogue synced: added ${missing.length} skills (${missing.map((s) => s.name).join(", ")}).`);
  } catch (e) {
